...
namespace WatcherEye.Core.Utilities;
...
internal static class Hash
{
    ...
    internal static int CombineValues<TKey, TValue>(ImmutableDictionary<TKey, TValue>? values,
    ...
    internal static int CombineValues(IEnumerable<string?>? values, StringComparer stringComparer,
        int maxItemsToHash = int.MaxValue)
    {
        if (values == null)
        {
    ...
    internal static int CombineValues(ImmutableArray<string> values, StringComparer stringComparer,
        int maxItemsToHash = int.MaxValue)
    {
        if (values == null)
            return 0;
